const styles = {
    ...
    driveTitle: 'text-[25px] font-[600] font-Roboto text-[#333]',
    driveDiscountPrice:"font-bold text-[18px] text-[#333] font-Roboto",
    price:"font-[500] text-[16px] text-[#d55b45] pl-3 mt-[-4px] line-through",
    charity_name:"pt-3 text-[15px] text-blue-400 pb-3",
